...
public class MenuOption{
	...
	public void Menu(){
		...
		String subjectType, description, providence;
		double duration;
		String title;
		double urgency;
		...
		Statistic historic = new Statistic();
		int day = 1;
			...
			switch(choice){
				...
				case 2:
					...
					if(indexNumArray > 0) {
						...
						// Adiciona no histórico o cliente removido da Heap
						historic.addClient(array[0], day);
				...
				case 5:	
					...
					historic.getClients( Integer.parseInt( subjectType ) , day);
					
					// Ordenando a Heap
					//heap.HeapSort(array);//heap.HeapSort(array);
